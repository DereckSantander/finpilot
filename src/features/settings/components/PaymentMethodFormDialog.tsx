...
export function PaymentMethodFormDialog({
  ...
  return (
    <FormDialog
      ...
      title={initial ? 'Editar método de pago' : 'Nuevo método de pago'}
      description="Vincula el método a una tarjeta para que sus gastos sumen a la deuda de esa tarjeta."
      submitLabel={initial ? 'Guardar cambios' : 'Crear'}
